...
public class CallfixLet extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		fb = jsonTools.getUser(tmp, FixInfo.class);
		...
		boolean reged = serv.Callfix(stuID, username, school, apartment, dormitory, detail);
		System.out.println("test" + reged);
		if (reged) {
			System.out.println("Insert callfix Info Succss");
			confirm="YES";
			//request.getSession().setAttribute("username", username);
			//response.sendRedirect("welcome.jsp");
		}else {
			System.out.println("Insert callfix Info Failed");
			confirm="NO";
		}
