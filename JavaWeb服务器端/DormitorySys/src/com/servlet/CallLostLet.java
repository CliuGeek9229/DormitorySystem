...
public class CallLostLet extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		fb = jsonTools.getUser(tmp, LostInfo.class);
		...
		System.out.println(stuID + "--" + username + "--"+reason);
		// 验证处理
		
		
		boolean reged = serv.CallLost(stuID, username, reason);
