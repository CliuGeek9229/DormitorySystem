...
import com.domain.FixInfo;
import com.domain.LateInfo;
import com.json.jsonTools;
import com.service.Service;

public class SignlateLet extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		fb = jsonTools.getUser(tmp, LateInfo.class);
		...
		System.out.println(stuID + "--" + username + "--"  + school + "--" + apartment + "--" + dormitory);
		// 验证处理
		
		
		boolean reged = serv.Signlate(stuID, username, school, apartment, dormitory);
		System.out.println("test" + reged);
		if (reged) {
			System.out.println("Insert signlate Info Succss");
			confirm="YES";
			//request.getSession().setAttribute("username", username);
			//response.sendRedirect("welcome.jsp");
		}else {
			System.out.println("Insert signlate Info Failed");
			confirm="NO";
		}
