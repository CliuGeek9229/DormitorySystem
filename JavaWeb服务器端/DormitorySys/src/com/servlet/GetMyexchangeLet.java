...
public class GetMyexchangeLet extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		confirm = serv.getMyexchange(tmp);
		
		if (confirm != null) {
			System.out.println("GetMyexchange Success!!!");
			System.out.println(confirm);
			
		}else {
			System.out.println("GetMyexchange failed");
			confirm="NO";
		}
