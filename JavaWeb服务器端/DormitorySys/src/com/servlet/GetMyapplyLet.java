...
public class GetMyapplyLet extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		confirm = serv.getMyapplyInfo(tmp);
		
		if (confirm != null) {
			System.out.println("GetMycallstay Success!!!");
			System.out.println(confirm);
			
		}else {
			System.out.println("GetMycallstay failed");
			confirm="NO";
		}
